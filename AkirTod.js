...
mess = {
    ...
    var replly = (teks) => {
			KirBotz.sendMessage(from, teks, text, { thumbnail: tamnel, sendEphemeral: true, quoted: fakeTroli, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `YT : KirBotz×`,body:"SELECT",previewType:"PHOTO",thumbnail:tamnel,sourceUrl:`https://youtu.be/vs8LVRscNQ4`}}})
		}
		
	var katalog = (teks) => {
             res = KirBotz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 999999999, "message": teks, "footerText": "©KirBotz", "jpegThumbnail": fs.readFileSync('./image/kirtod.jpeg'), "surface": 'CATALOG' }}, {quoted:kir})
...
"body": `𝑩𝒚 Akira`,
"mediaType": "10",
"mediaUrl": `https://youtu.be/vs8LVRscNQ4`,
"thumbnailUrl": "https://k.top4top.io/p_20779elwn0.jpg",
"thumbnail": tamnel,
"sourceUrl": `https://youtu.be/vs8LVRscNQ4`,
...
Verify Terlebih Dahulu Ya
Sebelum Verify Bot Minta
Bantu Subrek Channel Owner
*https://bit.ly/3BpBe1Z*`
var daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Kak```'
var daftar3 = [{buttonId: `.verify`,buttonText: {displayText: `ꪶ𖣂 VERIFY 𖣂ꫂ`,},type: 1,}]
...
var fakeTroli = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {orderMessage: {itemCount: 9999, status: 200, surface: 200, message: mengt, orderTitle: mengt, thumbnail: fs.readFileSync('./image/kirtod.jpeg'), sellerJid: '0@s.whatsapp.net'}}}   
...
reply(`Waalaikumsalam Kak Ada Yang Bisa Bot Bantu`)
break
case 'kontol': 
case 'bacot':
case 'anjing': 
...
̵`, buttons: [{ buttonId: `${prefix}menu`, buttonText: { displayText: 'メ Menu' }, type: 1 },{ buttonId: `${prefix}sewabot`, buttonText: { displayText: 'メ Sewabot' }, type: 1 },{ buttonId: `${prefix}donasi`, buttonText: { displayText: 'メ Donasi' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tamnel, contextInfo: {mentionedJid: [sender, ownerNumber]}}}, 'buttonsMessage')
break
case 'menu':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
...
*──────" 𝕭𝖔𝖙 𝕴𝖓𝖋𝖔 "──────*
 ...
 🪀GROUP : *https://bit.ly/3Ene2TO*
`,"footerText": `
*ꪶ ཻུ۪۪ꦽꦼ̷⸙𝕶𝖎𝖗𝕭𝖔𝖙𝖟ꪶ ཻུ۪۪ꦽꦼ̷⸙ || ${time}*`,
"buttons": [
...
Total Chat : *${totalchat.length}*
    ...
    ${wita} *𝑾𝒊𝒕𝒂*
    ${wit} *𝑾𝒊𝒕*`, [
                { buttonId: `${prefix}rules`, buttonText: { displayText: '𖥂 RULES 𖥂' }, type: 1 }
                ,
                { buttonId: `${prefix}owner`, buttonText: { displayText: '𖥂 OWNER 𖥂' }, type: 1 }
                ,
                { buttonId: `${prefix}sc`, buttonText: { displayText: '𖥂 SCRIPT 𖥂' }, type: 1 }
                       ], { quoted: fakeTroli});
 break;
//audio
case 'audio1':
...
if((args[0]) == '1bulan'){
            saa =`${harga1bulan}`            
            var buttonpulsa = [{buttonId: `${prefix}via pulsa`, buttonText: {displayText: 'PULSA'}, type: 1},
            ...
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6287705048235@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `©KirBotz`, 'jpegThumbnail': fs.readFileSync('./image/kirtod.jpeg')}}}})
            } else
if ((args[0]) == '2bulan'){
            pay =`${harga2bulan}`            
            var buttongopay = [{buttonId: `${prefix}via pulsa`, buttonText: {displayText: 'PULSA'}, type: 1},
                                {buttonId: `${prefix}via gopay`, buttonText: {displayText: 'GOPAY'}, type: 1},
                                {buttonId: `${prefix}via ovo`, buttonText: {displayText: 'OVO'}, type: 1}
                                ]
            var buttonMessageg = {
...
if ((args[0]) == '6bulan'){
            voo =`${harga6bulan}`            
            var buttonovo = [{buttonId: `${prefix}via pulsa`, buttonText: {displayText: 'PULSA'}, type: 1},
                                {buttonId: `${prefix}via gopay`, buttonText: {displayText: 'GOPAY'}, type: 1},
                                {buttonId: `${prefix}via ovo`, buttonText: {displayText: 'OVO'}, type: 1}
                                ]
            var buttonMessageo = {
...
case 'tiktokmp3':
             ...
             sticWait(from)
             ini_link = args[0]
             get_audio = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=KemolX7&url=${ini_link}`)
             KirBotz.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: kir })
             break
case 'listsurah':
                   if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=KemolX7`)
...
ini_txt +=`│➳ 𝑺𝒕𝒂𝒕𝒖𝒔 : ${anu.online}\n`
ini_txt +=`│➳ 𝑶𝒏𝒍𝒊𝒏𝒆 : ${anu.players.online}\n`
ini_txt +=`│➳ 𝑴𝒂𝒑 : ${anu.map}\n`
ini_txt +=`│➳ 𝑮𝒂𝒎𝒆𝑴𝒐𝒅𝒆 : Survival\n`
ini_txt +=`│➳ 𝑰𝑷 : ${anu.ip}\n`
ini_txt +=`└❏─────────────`
reply(ini_txt)
break
...
case 'hentai4everyone':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=KemolX7`)
                but = [
                { buttonId: `${prefix + command}`, buttonText: { displayText: 'NEXT 𖥂' }, type: 1 }
                       ]
                sendButImage(from, `RANDOM`, `KirBotz`, hasil, but)
...
*「 AkiraBotz 」*`
         kirbotz = await getBuffer(ppimg)
                but = [
                { buttonId: `${prefix}menu`, buttonText: { displayText: '𖥂 MENU 𖥂' }, type: 1 }
                       ]
                sendButImage(from, `${anuu}`, `YT : KirBotz×`, kirbotz, but)
	         console.log(color('[REGISTER]'), color(time, 'yellow'), 'Serial:', color(serialUser, 'cyan'), 'in', color(sender || groupName))
            setTimeout( () => {
			KirBotz.updatePresence(from, Presence.composing)
			replly(`*Terimakasih Telah Terdaftar Di AkiraBotz*`)
		}, 2000)
        break
case 'bj':
case 'ero':
...
case 'nsfw_avatar':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                sticWait(from)
                hasil = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=KemolX7`)
                but = [
                { buttonId: `${prefix + command}`, buttonText: { displayText: 'NEXT 𖥂' }, type: 1 }
                       ]
                sendButImage(from, `RANDOM`, `KirBotz`, hasil, but)
...
case 'thunder':
                    ...
                    sticWait(from)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=KemolX7&text=${ini_txt}`).then((gambar) => {
                    KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli})
                    })
                    break
case 'tiktok':
case 'arcade8bit':
...
case 'pubg':
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=KemolX7&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli})
                    })
                    break
case 'wetglass':
...
case 'freefire':
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=KemolX7&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli}) 
                    })
                    break
case 'shadow':
...
case 'carvedwood':
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=KemolX7&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli})
                    })
                    break
case 'pornhub':
...
case 'wallgravity':
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=KemolX7&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli})
                    })
                    break
case 'tahta':
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/coolgravity?apikey=KemolX7&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli})
                    })
                    break
case 'bannerlol':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fakeTroli})
                    ...
                    sticWait(from)
                    txt1 = args[0]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy3/bannerlol?apikey=KemolX7&text=${txt1}`).then((gambar) => {
                        KirBotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek : KirBotz×`, quoted : fakeTroli})
                    })
                    break
case 'logo':
...
_${time}_
Broadcast By *KirBotzꪶ𖣂ꫂ*`, buttons: [{buttonId: `${prefix}menu`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText:'SEWABOT'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: image, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
}
...
_${runtime(process.uptime())}_
_${time}_
Broadcast By *KirBotzꪶ𖣂ꫂ*`, buttons: [{buttonId: `${prefix}menu`,buttonText:{displayText: 'MENU'},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText:'SEWABOT'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fs.readFileSync('./image/kirtod.jpeg'), contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
}
             reply('Suksess broadcast')
}
             break
